...
const Footer = () => {
    return (
        <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
            <div>
                <img className='size-15' src="/icons8-mango-48.png" alt="" />
            ...
            <div>
                <p>Copyright © {new Date().getFullYear()} - All right reserved by <a className=" font-bold"><span className='text-green-600'>Mango</span><span className='text-yellow-500'>Fango</span></a></p>
            </div>
